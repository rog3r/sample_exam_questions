...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { correct: @option.correct, question_id: @option.question_id, text: @option.text, weight: @option.weight }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { correct: @option.correct, question_id: @option.question_id, text: @option.text, weight: @option.weight }
    assert_redirected_to option_path(assigns(:option))
  end
